/**
 * @fileoverview Dropdown menus for selecting Latin authors and texts to search.
 * 
 * @author [Jeff Kinnison](https://github.com/jeffkinnison)
 * @author [Abby Swenor](https://github.com/aswenor)
 * 
 * @exports LatinTextSelectDropdowns
 * 
 * @requires NPM:react
 ...
 *   )
 */
function LatinTextSelectDropdowns(props) {
...
LatinTextSelectDropdowns.propTypes = {
  /**
...
export default LatinTextSelectDropdowns;
